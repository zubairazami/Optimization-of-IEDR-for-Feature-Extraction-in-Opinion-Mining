...
class ActualFeatureExtractionThread(QThread):
    feature_list_update_signal = pyqtSignal(list)
    ...
    def connect_all(self, on_feature_list_received):
        self.feature_list_update_signal.connect(on_feature_list_received)
    ...
    def run(self):
        ...
        self.feature_list_update_signal.emit(feature_list)
