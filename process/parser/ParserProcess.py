...
class Parse:
    ...
    def __init__(self, file_path):
        ...
        self.parser = stanford.StanfordParser(
            model_path=os.path.expanduser(
                '~') + "/stanford-parser-full-2015-04-20/stanford-parser-3.5.2-models/edu/stanford/nlp/models/lexparser/englishPCFG.ser.gz")
    ...
    def conj_nsubj_dobj_check(self, c_token, t_list):
        ...
        if c_token.deprel == 'conj':
            if head_token.deprel == 'nsubj' and self.nominal_subject_relationship(head_token, t_list) is not None:
                return c_token.form
            elif head_token.deprel == 'dobj' and self.direct_object_relationship(head_token, t_list) is not None:
                return c_token.form
            else:
                return None
        return None
